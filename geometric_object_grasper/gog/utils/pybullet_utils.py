...
from geometric_object_grasper.gog.utils.orientation import Quaternion
...
def load_obj(obj_path, scaling, position=[0, 0, 0], orientation=Quaternion(), fixed_base=False):
