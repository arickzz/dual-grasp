...
from scripts.mesh_utils import Object
...
def load_grasp_path(root_folder):
    ...
    """
    split_dict = {}
    split_paths = glob.glob(os.path.join(root_folder, 'full/af8f382971e82cf3b64aa241ebb4a005_0.01961396951275699.h5')) #need to change this name
    return split_paths
...
if __name__ == "__main__":
    ...
    parser.add_argument('--gripper_path', type=str, default='DA2/scripts/grippers/robotiq_85/gripper.obj',help='gripper file')
    parser.add_argument('--config_path', type=str, default='/home/vislab/DA2/scripts/scene.yaml')
